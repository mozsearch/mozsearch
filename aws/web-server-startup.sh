...
nohup livegrep/bin/codesearch -listen tcp://localhost:8080 -load_index $HOME/index/livegrep.idx -max_matches 1000 > $HOME/codesearch.log 2> $HOME/codesearch.err < /dev/null &
cd mozsearch
sleep 10
