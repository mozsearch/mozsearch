...
while (true) {
  ...
  // Skip analysis if the output already exists (if it was generated by scip-typescript/scip-indexer for instance).
  try {
    os.file.readFile(analysisFile);
    printErr(`INFO Skipping analysis of ${sourcePath} because the output file already exists (probably because of scip-typescript/scip-indexer or an earlier js-analyze run)`);
    continue;
  } catch {
    // pass
  }
