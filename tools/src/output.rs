    ...
    let f = F::Seq(vec![
        ...
        F::Indent(vec![
            ...
            F::Indent(vec![
                ...
                F::T(format!(
                    r#"<a id="open-help" title="Open help page" href="https://firefox-source-docs.mozilla.org/contributing/searchfox/searchfox_search.html" target="_blank"><span class="navpanel-icon icon-help-circled" aria-hidden="false"></span></a><a id="show-settings" title="Go to settings page" href="/{}/pages/settings.html"><span class="navpanel-icon icon-cog expanded" aria-hidden="false"></span></a>"#,
                    opt.tree_name
                )),
                F::S(r#"</span>"#),
            ]),
