...
do
    ...
    MOZSEARCH_PLATFORM=$PLATFORM $CXX -DTEST_MACRO1 -DTEST_MACRO2 -DTARGET_$MACRO_PLATFORM ${EXTRA_OPTS} -DTEST_MACRO_INCLUDE='"nsISupports.h"' $SRC_FILE -std=c++26 -I . -I $OBJDIR -c -o $OBJ_FILE -Wall
