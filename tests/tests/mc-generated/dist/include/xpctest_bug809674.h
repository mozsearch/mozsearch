...
class NS_NO_VTABLE nsIXPCTestBug809674 : public nsISupports {
 public:
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD AddVals(JS::Handle<JS::Value> x, JS::Handle<JS::Value> y, JSContext* cx, JS::MutableHandle<JS::Value> _retval) = 0;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetValProperty(JSContext* cx, JS::MutableHandle<JS::Value> aValProperty) = 0;
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD SetValProperty(JSContext* cx, JS::Handle<JS::Value> aValProperty) = 0;
...
#define NS_DECL_NSIXPCTESTBUG809674 \
  ...
  NS_IMETHOD AddVals(JS::Handle<JS::Value> x, JS::Handle<JS::Value> y, JSContext* cx, JS::MutableHandle<JS::Value> _retval) override; \
  ...
  NS_IMETHOD GetValProperty(JSContext* cx, JS::MutableHandle<JS::Value> aValProperty) override; \
  NS_IMETHOD SetValProperty(JSContext* cx, JS::Handle<JS::Value> aValProperty) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIXPCTESTBUG809674 \
  ...
  nsresult AddVals(JS::Handle<JS::Value> x, JS::Handle<JS::Value> y, JSContext* cx, JS::MutableHandle<JS::Value> _retval); \
  ...
  nsresult GetValProperty(JSContext* cx, JS::MutableHandle<JS::Value> aValProperty); \
  nsresult SetValProperty(JSContext* cx, JS::Handle<JS::Value> aValProperty); \
...
#define NS_FORWARD_NSIXPCTESTBUG809674(_to) \
  ...
  NS_IMETHOD AddVals(JS::Handle<JS::Value> x, JS::Handle<JS::Value> y, JSContext* cx, JS::MutableHandle<JS::Value> _retval) override { return _to AddVals(x, y, cx, _retval); } \
  ...
  NS_IMETHOD GetValProperty(JSContext* cx, JS::MutableHandle<JS::Value> aValProperty) override { return _to GetValProperty(cx, aValProperty); } \
  NS_IMETHOD SetValProperty(JSContext* cx, JS::Handle<JS::Value> aValProperty) override { return _to SetValProperty(cx, aValProperty); } \
...
#define NS_FORWARD_SAFE_NSIXPCTESTBUG809674(_to) \
  ...
  NS_IMETHOD AddVals(JS::Handle<JS::Value> x, JS::Handle<JS::Value> y, JSContext* cx, JS::MutableHandle<JS::Value> _retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->AddVals(x, y, cx, _retval); } \
  ...
  NS_IMETHOD GetValProperty(JSContext* cx, JS::MutableHandle<JS::Value> aValProperty) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValProperty(cx, aValProperty); } \
  NS_IMETHOD SetValProperty(JSContext* cx, JS::Handle<JS::Value> aValProperty) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetValProperty(cx, aValProperty); } \
