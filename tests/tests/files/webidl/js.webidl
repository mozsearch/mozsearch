...
interface JSWebIDLPartialInterface {
  attribute any jsWebIDLPartialAttr1;
};

partial interface JSWebIDLPartialInterface {
  attribute any jsWebIDLPartialAttr2;
};

namespace JSWebIDLPartialNamespace {
  any jsWebIDLPartialMethod1();
};

partial namespace JSWebIDLPartialNamespace {
  any jsWebIDLPartialMethod2();
};
...
interface JSWebIDLConflictingMany1 {
  attribute any jsWebIDLConflictAttrMany;
};
interface JSWebIDLConflictingMany2 {
  attribute any jsWebIDLConflictAttrMany;
};
interface JSWebIDLConflictingMany3 {
  attribute any jsWebIDLConflictAttrMany;
};
interface JSWebIDLConflictingMany4 {
  attribute any jsWebIDLConflictAttrMany;
};
